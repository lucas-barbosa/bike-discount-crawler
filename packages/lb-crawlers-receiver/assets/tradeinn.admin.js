(function ($) {
  ...
  $(document).ready(() => {
    ...
    $(document).on('input', '.wp-category-autocomplete', function () {
      ...
      const ALL_CATEGORIES = lb_crawlers_receiver_tradeinn.all_site_categories || [];
    ...
    const overrideCategories = lb_crawlers_receiver_tradeinn.override_categories || [];
    ...
    const getOverrideCategoryName = (category) => {
      ...
      let overrideCatName = '';
      if (overrideCatId && lb_crawlers_receiver_tradeinn.all_site_categories) {
        const cat = lb_crawlers_receiver_tradeinn.all_site_categories.find(c => String(c.id) === String(overrideCatId));
    ...
    function processOverrideCategories() {
      ...
      $.ajax({
        ...
        data: {
          categories: $categories,
          action: 'tradeinn_process_override_categories',
          nonce: lb_crawlers_receiver_tradeinn.nonce
        },
        dataType: 'JSON',
        success: function () {
