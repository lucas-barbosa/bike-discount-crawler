...
class SaveSettingsAjax {
  public function run() {
    ...
    add_action('wp_ajax_tradeinn_delete_products_by_category', array($this, 'handle_delete_products_by_category'));
  }
  ...
  public function handle_delete_products_by_category() {
    ...
    do_action('lb_tradeinn_delete_products_by_category_async', $category, $category_path);
