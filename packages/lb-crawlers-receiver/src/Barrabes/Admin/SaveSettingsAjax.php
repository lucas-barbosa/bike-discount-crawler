...
class SaveSettingsAjax {
  public function run() {
    add_action('wp_ajax_barrabes_process_selected_categories', array($this, 'process_selected_categories'));
    add_action('wp_ajax_barrabes_process_categories_dimension', array($this, 'process_categories_dimension'));
    ...
    add_action('wp_ajax_barrabes_delete_products_by_category', array($this, 'handle_delete_products_by_category'));
  }
  ...
  public function handle_delete_products_by_category() {
    ...
    do_action('lb_barrabes_delete_products_by_category_async', $category, $category_path);
